 ...
 * @version     $Id: back_in_stock_notifications.php 937 2022-08-16 torvista
 */
// BMH 2022-08-26   ln 192 210 Undefined array key page 
//                  ln 540 Undefined variable $pagination_column
//                  PHP 8.0.20
//                  ln29 declare arrays for email
//                  $pagination_columns not declared
//      2022-08-31  email array extended URL_TEXT
/**
 * Version info - don't touch!
 */
define('CEON_BACK_IN_STOCK_NOTIFICATIONS_VERSION', '3.2.2'); // BMH updated from 3.2.0 to 3.2.2
if (!defined('TEXT_SORT_BY_PRODUCT_MODEL')) define('TEXT_SORT_BY_PRODUCT_MODEL','');  // BMH 2019 PHP 7 error
...
require_once(DIR_WS_FUNCTIONS . 'back_in_stock_notifications_functions.php');  // BMH addin
...
switch($_GET['option']){
    case 1:
        $products_query_raw = "
            SELECT
                bisns.product_id, p.products_model, pd.products_name, 
                COUNT(*) AS num_subscribers, p.products_type,
            ...
            WHERE
                1 = 1
            GROUP BY
                bisns.product_id, p.products_model, pd.products_name, p.products_type, p.products_quantity, cd.categories_name, cd.categories_id";
        ...
        if (($_GET['page'] ?? ' ' ) != -1) { // BMH Undefined array key "page"
    ...
    case 2:
        $subscriptions_query_raw = "
            SELECT
                DISTINCT bisns.id, bisns.product_id, p.products_model, bisns.name, bisns.email_address,
    ...
    case 3:             // perform a test run
        $send_output = sendBackInStockNotifications(true);
        
        break;
        
    case 4:             // send notification emails
...
<head>
    ...
    <style type="text/css">
    #ceon-bisn-wrapper { margin: 0 0.8em 0 0.8em; }
    ...
    fieldset.CeonPanel fieldset legend { background: transparent;  }
    ...
    .DoubleSpaceBelow { margin-bottom: 2em; }
    ...
    #ceon-bisn-wrapper th a { font-size: 1em; }
    
    #ceon-bisn-wrapper th.ClickToSort:hover { background: #d0d0d0;  }
    ...
    #ceon-bisn-wrapper td.BISNPageCount { padding: 0.4em 0;  }
    ...
    #ceon-bisn-wrapper td.dataTableContent a { font-size: 1.1em; }
    ...
    #footer #check-for-updates a {  font-size: 0.9em; } 
            ...
            <fieldset id="main-panel" class="CeonPanel">
                ...
                <?php
                    ...
                    if (isset($_GET['page']) && $_GET['page'] != -1) {
                            ...
                            if(!isset($pagination_columns)) {$pagination_columns = ''; //} // BMH  Undefined variable $pagination_columns
                    ...
                    ?>
                        <fieldset class="NoMarginBottom">
                            ...
                            <table border="0" cellspacing="1" cellpadding="2" align="center">
                                <tr>
                                    <td colspan="5" class="BISNPaginationWrapper"><?php echo ($pagination_columns) ?? ' '; ?></td><!-- // BMH colspan 4 -> 5 -->
                                </tr>
                                <tr>
                                    <?php    
                                    ...
                                    echo '<th>' . TABLE_HEADING_PRODUCT_ID . '</th>'; //    echo '<th>' . TABLE_HEADING_PRODUCT_ID . '</th>'; // BMH
                                    ...
                                    if ($sort_column == 'model') {
                                        ...
                                        echo '<th class="ClickToSort"><a href="' .
                                            zen_href_link(FILENAME_CEON_BACK_IN_STOCK_NOTIFICATIONS,
                                            zen_get_all_get_params(array('sort', 'action')) . 'sort=model') .
   ...
   echo '<th>' . TABLE_HEADING_PRODUCT_ID . '</th>';
    ...
    ?>
                    ...
                    $subscriptions_info->fields['products_type']);?>
                                        ...
                                        <td class="dataTableContent<?php if ($even) echo ' Even';?>">
                                            <?php echo buildLinkToProductAdminPage(
                    $subscriptions_info->fields['products_model'],
                    $subscriptions_info->fields['product_id'], 
                    $subscriptions_info->fields['products_type']);?>
</td>
                                        <td class="dataTableContent<?php if ($even) echo ' Even';?>">
